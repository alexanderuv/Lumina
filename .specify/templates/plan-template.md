...
### I. API Documentation
- [ ] All new public APIs have complete documentation (descriptions, parameters, return values, examples)
- [ ] No public symbols exposed without documentation

### II. No Broken States
- [ ] All commits will compile and pass tests
- [ ] WIP features are feature-flagged or in separate branches

### III. Swift 6.2+ Modern Idioms
- [ ] Uses Swift 6.2+ features (strict concurrency, modern result builders, type-safe APIs)
...
- [ ] Uses borrowing ownership model (`borrowing`, `consuming`) where feasible
- [ ] Minimizes ARC overhead in performance-critical paths
- [ ] Documents justification when ARC is required
- [ ] Prefers value types and stack allocation where possible
